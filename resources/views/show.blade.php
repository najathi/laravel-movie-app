        ...
        @if (count($movie['videos']['results']) > 0)
          <div class="mt-12">
            <a
              ...
              class="flex inline-flex items-center bg-orange-700 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
            ...
            <div class="mt-8">
              <a href="#">
                <img
                  ...
                  alt="{{ $image['file_path'] }}" class="hover:opacity-75 transition ease-in-out duration-150">
              </a>
            </div>
          @endif
        @endforeach
